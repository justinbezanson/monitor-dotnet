        ...
        <div class="pt-4 border-t space-y-1">
          <div class="flex items-center gap-3 px-3 py-4 mb-2">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold truncate">Justin Doe</p>
              <p class="text-xs text-muted-foreground truncate">System Administrator</p>
            </div>
          </div>
          <a href="#" class="flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium text-red-500 hover:bg-red-500/10 transition-colors">
